    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-slate-900/95 backdrop-blur-md border-b border-white/10">
      <div className="container mx-auto px-4 max-w-7xl">
        <div className="flex items-center justify-between h-16">
          <Link href="/" onClick={() => setMobileAppModalOpen(false)} className="text-xl font-bold text-white hover:text-blue-400 transition-colors flex items-center gap-2">
            TickerGrade
            <span className="text-xs font-medium bg-slate-700 text-slate-300 px-1.5 py-0.5 rounded">Beta</span>
          </Link>
